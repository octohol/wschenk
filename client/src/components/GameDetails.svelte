<script lang="ts">
    ...
    /**
     * Render star rating as visual symbols based on numeric rating.
     * @param {number | null} rating - The numeric rating from 0 to 5, or null if not rated
     * @returns {string} String representation using star symbols (★, ½, ☆)
     */
